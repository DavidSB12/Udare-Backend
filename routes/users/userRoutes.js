...
const {getAllUsers, getUserById, updateUserById, deleteUserById, getUserByUid, addUser, getFollowingOfUser,getFollowersOfUser, followUser, unfollowUser, updateUserByIdImage, getNotFollowingUsers, getTopUsers, getTopUsersFriends} = require("../../controllers/user-controller.js")
...
router.put("/updateImage/:id",upload.fields([{ name: 'image', maxCount: 1 }, { name: 'user', maxCount: 1 }]) , updateUserByIdImage);
